...
export class PitchFork extends ThreePointDrawing {
	...
	_recalculateLines() {
		...
		let offset1 = BaseLine.verticalOffsetOfParallelLine(_x1, _y1, pt3.x, pt3.y, pt1.x, pt1.y)
		let offset2 = BaseLine.verticalOffsetOfParallelLine(_x1, _y1, pt3.x, pt3.y, pt2.x, pt2.y)
		let offset4 = BaseLine.verticalOffsetOfParallelLine(_x1, _y1, pt3.x, pt3.y, pt4.x, pt4.y)
		let offset5 = BaseLine.verticalOffsetOfParallelLine(_x1, _y1, pt3.x, pt3.y, pt5.x, pt5.y)

		let stage = this.root as IStage
		if (!stage) return

		const {width, height} = stage.bounds
		let remotePoint1 = BaseLine.remotePointOfRay(_x1, _y1 + offset1, pt3.x, pt3.y + offset1, width, height)
		let remotePoint2 = BaseLine.remotePointOfRay(_x1, _y1 + offset2, pt3.x, pt3.y + offset2, width, height)
		let remotePoint3 = BaseLine.remotePointOfRay(_x1, _y1, pt3.x, pt3.y, width, height)
		let remotePoint4 = BaseLine.remotePointOfRay(_x1, _y1 + offset4, pt3.x, pt3.y + offset4, width, height)
		let remotePoint5 = BaseLine.remotePointOfRay(_x1, _y1 + offset5, pt3.x, pt3.y + offset5, width, height)
