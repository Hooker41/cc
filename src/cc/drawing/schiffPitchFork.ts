...
export class SchiffPitchFork extends ThreePointDrawing {
	...
	_recalculateLines() {
		...
		let offset1 = BaseLine.verticalOffsetOfParallelLine(origin.x, origin.y, pt3.x, pt3.y, pt1.x, pt1.y)
		let offset2 = BaseLine.verticalOffsetOfParallelLine(origin.x, origin.y, pt3.x, pt3.y, pt2.x, pt2.y)
		let offset4 = BaseLine.verticalOffsetOfParallelLine(origin.x, origin.y, pt3.x, pt3.y, pt4.x, pt4.y)
		...
		let remotePoint4 = BaseLine.remotePointOfRay(origin.x, origin.y + offset4, pt3.x, pt3.y + offset4, width, height)
		let remotePoint5 = BaseLine.remotePointOfRay(origin.x, origin.y + offset5, pt3.x, pt3.y + offset5, width, height)
		...
		this.line3.x1 = origin.x
		this.line3.y1 = origin.y
